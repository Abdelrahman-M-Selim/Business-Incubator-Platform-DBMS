...
const AddResourceForm = ({ onClose, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div
        className="bg-white border-4 border-black w-full max-w-lg
      ...
      >
        ...
        <div className="p-6 border-b-4 border-black flex items-center justify-between">
          ...
          <button
            ...
            rounded-full font-black text-2xl
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex gap-4">
            <div className="flex-1">
              <label className="block font-black text-sm mb-1">Capacity</label>
              <input
                type="number"
                min="1"
                className="w-full border-4 border-black p-3 rounded-2xl
            ...
            <div className="flex-1">
              <label className="block font-black text-sm mb-1">Location</label>
              <input
                required
                className="w-full border-4 border-black p-3 rounded-2xl
                font-bold outline-none
          ...
          <button
            className="w-full bg-black text-white font-black text-lg py-4
            mt-6 rounded-2xl border-4 border-black
            hover:bg-[#FFDE59] hover:text-black
